...
public class ForecastFragment extends Fragment {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
         ...
         *
         * Fortunately parsing is easy: construct takes the JSON string and converts it
        ...
        private String[] getWeatherDataFromJson(String forecastJsonStr, int numDays)
            ...
            // asked for, which means that we need to know th GMT offset to translate this data
            // properly.
            ...
            int julianSatrtDay = Time.getJulianDay(System.currentTimeMillis(), dayTime.gmtoff);

            // new we work exclusively in UTC
            dayTime = new Time();
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                dateTime = dayTime.setJulianDay(julianSatrtDay + i);
        ...
        protected void onPostExecute(String[] result) {
            if (result != null) {
                ...
                for (String dayForecastStr : result) {
                    weeklyForecast.add(dayForecastStr);
                }

                mForecastAdapter.addAll(weeklyForecast);
